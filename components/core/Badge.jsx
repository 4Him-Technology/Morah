...
export function Badge({ children, tone = 'neutral', solid = false, style = {}, ...rest }) {
  const tones = {
    neutral: { soft: { bg: 'var(--gray-100)', fg: 'var(--gray-600)' }, solid: { bg: 'var(--gray-900)', fg: '#fff' } },
    berry:   { soft: { bg: 'var(--berry-50)', fg: 'var(--berry-700)' }, solid: { bg: 'var(--berry-600)', fg: '#fff' } },
    leaf:    { soft: { bg: 'var(--leaf-50)', fg: 'var(--leaf-700)' }, solid: { bg: 'var(--leaf-600)', fg: '#fff' } },
